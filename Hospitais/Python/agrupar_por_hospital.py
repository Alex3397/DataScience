...
print(lista_tabelas)
print('')
lista_tabelas = lista_tabelas.sort_values(by='tablename')
...
def count_codes(codes):
    c_1 = 0;c_1_1 = 0;c_1_2 = 0;c_1_3 = 0;c_1_4 = 0;c_1_5 = 0
    ...
    for x in range(0,len(codes)):
        ...
        if isinstance(code, str):
            ...
            c_1_5 +=1 if '1.5' in code else 0
            c_2 +=1 if '2' == code else 0
            c_2_1 +=1 if '2.1' in code and '5.' not in code else 0
            c_2_2 +=1 if '2.2' in code and '5.' not in code else 0
            c_2_3 +=1 if '2.3' in code and '5.' not in code else 0
            c_2_4 +=1 if '2.4' in code and '5.' not in code else 0
            c_2_5 +=1 if '2.5' in code and '5.' not in code else 0
    ...
    print("1: {}".format(c_1)) if c_1 > 0 else 0
    print("1.1: {}".format(c_1_1)) if c_1_1 > 0 else 0
    print("1.2: {}".format(c_1_2)) if c_1_2 > 0 else 0
    print("1.3: {}".format(c_1_3)) if c_1_3 > 0 else 0
    print("1.4: {}".format(c_1_4)) if c_1_4 > 0 else 0
    print("1.5: {}".format(c_1_5)) if c_1_5 > 0 else 0
    print("2: {}".format(c_2)) if c_2 > 0 else 0
    print("2.1: {}".format(c_2_1)) if c_2_1 > 0 else 0
    print("2.2: {}".format(c_2_2)) if c_2_2 > 0 else 0
    print("2.3: {}".format(c_2_3)) if c_2_3 > 0 else 0
    print("2.4: {}".format(c_2_4)) if c_2_4 > 0 else 0
    print("2.5: {}".format(c_2_5)) if c_2_5 > 0 else 0
    print("3: {}".format(c_3)) if c_3 > 0 else 0
    print("3.1: {}".format(c_3_1)) if c_3_1 > 0 else 0
    print("3.2: {}".format(c_3_2)) if c_3_2 > 0 else 0
    print("3.3: {}".format(c_3_3)) if c_3_3 > 0 else 0
    print("3.4: {}".format(c_3_4)) if c_3_4 > 0 else 0
    print("3.5: {}".format(c_3_5)) if c_3_5 > 0 else 0
    print("3.6: {}".format(c_3_6)) if c_3_6 > 0 else 0
    print("3.7: {}".format(c_3_7)) if c_3_7 > 0 else 0
    print("4: {}".format(c_4)) if c_4 > 0 else 0
    print("4.1: {}".format(c_4_1)) if c_4_1 > 0 else 0
    print("4.2: {}".format(c_4_2)) if c_4_2 > 0 else 0
    print("4.3: {}".format(c_4_3)) if c_4_3 > 0 else 0
    print("5: {}".format(c_5)) if c_5 > 0 else 0
    print("5.1: {}".format(c_5_1)) if c_5_1 > 0 else 0
    print("5.1.1: {}".format(c_5_1_1)) if c_5_1_1 > 0 else 0
    print("5.1.2: {}".format(c_5_1_2)) if c_5_1_2 > 0 else 0
    print("5.2: {}".format(c_5_2)) if c_5_2 > 0 else 0
    print("5.3: {}".format(c_5_3)) if c_5_3 > 0 else 0
    print("5.3.1: {}".format(c_5_3_1)) if c_5_3_1 > 0 else 0
    print("5.3.2: {}".format(c_5_3_2)) if c_5_3_2 > 0 else 0
    print("5.3.3: {}".format(c_5_3_3)) if c_5_3_3 > 0 else 0
    print("5.3.4: {}".format(c_5_3_4)) if c_5_3_4 > 0 else 0
    print("5.3.5: {}".format(c_5_3_5)) if c_5_3_5 > 0 else 0
    print("5.4: {}".format(c_5_4)) if c_5_4 > 0 else 0
    print("5.5: {}".format(c_5_5)) if c_5_5 > 0 else 0
    print("5.6: {}".format(c_5_6)) if c_5_6 > 0 else 0
    print("6: {}".format(c_6)) if c_6 > 0 else 0
    print("7: {}".format(c_7)) if c_7 > 0 else 0

    return [c_1, c_1_1, c_1_2, c_1_3, c_1_4, c_1_5, c_2, c_2_1, c_2_2, c_2_3, c_2_4, c_2_5, c_3, c_3_1, c_3_2, c_3_3, c_3_4, c_3_5, c_3_6, c_3_7, c_4, c_4_1, c_4_2, c_4_3, c_5, c_5_1, c_5_1_1, c_5_1_2, c_5_2, c_5_3, c_5_3_1, c_5_3_2, c_5_3_3, c_5_3_4, c_5_3_5, c_5_4, c_5_5, c_5_6, c_6, c_7]
...
#FAZER UPDATE NAS TABELAS DESTINO
for i in range(0,length):
    tabela = lista_tabelas.iloc[i,-1]
...
os.system('python3 /home/alexandre/Dev/DataScience/Hospitais/Python/ses.py')
print('')
...
for x in range(0,length):
    tabela_destino = tabelas_destino.iloc[x,-1]
    df = pd.read_sql_query('select * from {e}.{td}'.format(e=exportar,td=tabela_destino), engine)
    destino = '/home/alexandre/Dev/DataScience/Hospitais/extraidos/group_by_hospital/' + str(tabela_destino) + '.xlsx'
    print(df)
    df.to_excel(excel_writer=destino, index=False)
