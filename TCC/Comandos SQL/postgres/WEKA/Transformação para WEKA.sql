...
update weka.condicao_e_abastecimento_de_agua_2016_2018
  ...
  select * from weka.condicao_e_abastecimento_de_agua_2016_2018;

select * from weka.condicao_e_abastecimento_de_agua_2016_2018;
select * from pronto_para_regressao.habitacao_agua_rede_geral_de_distribuicao_mil_pessoas;
...
update weka.tipo_de_domicilio_2016_2018
  ...
  select * from weka.tipo_de_domicilio_2016_2018;
...
update weka.combustivel_utilizado_para_preparar_alimentos_2016_2018
  ...
  select * from weka.combustivel_utilizado_para_preparar_alimentos_2016_2018;
...
update weka.condicao_de_ocupacao_2016_2018
  ...
  select * from weka.condicao_de_ocupacao_2016_2018;
...
update weka.fonte_de_energia_eletrica_2016_2018
  ...
  select * from weka.fonte_de_energia_eletrica_2016_2018;
...
update weka.esgotamento_sanitario_2016_2018
  ...
  select * from weka.esgotamento_sanitario_2016_2018;
...
update weka.destino_do_lixo_2016_2018
  ...
  select * from weka.destino_do_lixo_2016_2018;
...
update weka.condicao_das_paredes_2016_2018
  ...
  select * from weka.condicao_das_paredes_2016_2018;
...
update weka.condicao_do_piso_2016_2018
  ...
  select * from weka.condicao_do_piso_2016_2018;
...
update weka.condicao_do_telhado_2016_2018
  ...
  select * from weka.condicao_do_telhado_2016_2018;

  drop table weka.pessoas_ocupadas_no_setor_de_2012_2017;
  create table weka.pessoas_ocupadas_no_setor_de_2012_2017 (
   "Ano" numeric,
   "Adm.púb, Def e Seg.soc, Educ, Saú e Serv.soc (mil pessoas)" numeric,
   "Informação, comunicação e Ativ.finan imobi (mil pessoas)" numeric,
   "Agri, pecuária, prod.florestal, pesca e aquicul (mil pessoas)" numeric,
   "Comer, repar de automotores e motocicletas (mil pessoas)" numeric,
  ...
  set "Adm.púb, Def e Seg.soc, Educ, Saú e Serv.soc (mil pessoas)" = "Acre"
  ...
  update weka.pessoas_ocupadas_no_setor_de_2012_2017
  set "Informação, comunicação e Ativ.finan imobi (mil pessoas)" = "Acre"
  ...
  update weka.pessoas_ocupadas_no_setor_de_2012_2017
  set "Agri, pecuária, prod.florestal, pesca e aquicul (mil pessoas)" = "Acre"
  ...
  update weka.pessoas_ocupadas_no_setor_de_2012_2017
  set "Comer, repar de automotores e motocicletas (mil pessoas)" = "Acre"
  ...
  select * from weka.pessoas_ocupadas_no_setor_de_2012_2017;

drop table weka.local_de_estabelecimento_2012_2017;
  create table weka.local_de_estabelecimento_2012_2017 (
   "Ano" numeric,
   "Local definido por empregador patrão ou freguês (mil pessoas)" numeric,
   "Morada do empregador patrão sócio ou freguês (mil pessoas)" numeric,
   "Estabelecimento do próprio empreendimento (mil pessoas)" numeric,
   "Estabelecimento de outro empreendimento (mil pessoas)" numeric,
   "Fazenda sítio granja chácara etc (mil pessoas)" numeric,
   "Domicílio de residência (mil pessoas)" numeric,
   "Via ou área pública (mil pessoas)" numeric,
   "Veículo automotor (mil pessoas)" numeric,
   "Outro local (mil pessoas)" numeric);
  ...
  set "Local definido por empregador patrão ou freguês (mil pessoas)" = "Acre"
  ...
  update weka.local_de_estabelecimento_2012_2017
  set "Morada do empregador patrão sócio ou freguês (mil pessoas)" = "Acre"
  ...
  update weka.local_de_estabelecimento_2012_2017
  set "Estabelecimento do próprio empreendimento (mil pessoas)" = "Acre"
  ...
  update weka.local_de_estabelecimento_2012_2017
  set "Estabelecimento de outro empreendimento (mil pessoas)" = "Acre"
  ...
  update weka.local_de_estabelecimento_2012_2017
  set "Fazenda sítio granja chácara etc (mil pessoas)" = "Acre"
  ...
  update weka.local_de_estabelecimento_2012_2017
  set "Domicílio de residência (mil pessoas)" = "Acre"
  ...
  update weka.local_de_estabelecimento_2012_2017
  set "Via ou área pública (mil pessoas)" = "Acre"
  ...
  update weka.local_de_estabelecimento_2012_2017
  set "Veículo automotor (mil pessoas)" = "Acre"
  ...
  update weka.local_de_estabelecimento_2012_2017
  set "Outro local (mil pessoas)" = "Acre"
  ...
  select * from weka.local_de_estabelecimento_2012_2017;
...
drop table weka.tamanho_do_empreendimento_2012_2017;
  ...
  select * from weka.tamanho_do_empreendimento_2012_2017;
...
drop table weka.condicao_de_ensino_2012_2017;
  ...
  select * from weka.condicao_de_ensino_2012_2017;
...
drop table weka.condicao_do_empreendimento_2012_2017;
  ...
  select * from weka.condicao_do_empreendimento_2012_2017;
...
drop table weka.condicao_no_domicilio_2012_2017;
  ...
  select * from weka.condicao_no_domicilio_2012_2017;
...
drop table weka.condicao_de_assiciacao_a_sindicato_2012_2017;
  ...
  select * from weka.condicao_de_assiciacao_a_sindicato_2012_2017;

drop table weka.assiciacao_a_cooperativas_de_trabalho_producao_2012_2017;
  create table weka.assiciacao_a_cooperativas_de_trabalho_producao_2012_2017 (
   "Ano" numeric,
   "Não associadas (mil pessoas)" numeric);

   insert into weka.assiciacao_a_cooperativas_de_trabalho_producao_2012_2017 ("Ano") values ('2012');
   insert into weka.assiciacao_a_cooperativas_de_trabalho_producao_2012_2017 ("Ano") values ('2013');
   insert into weka.assiciacao_a_cooperativas_de_trabalho_producao_2012_2017 ("Ano") values ('2014');
   insert into weka.assiciacao_a_cooperativas_de_trabalho_producao_2012_2017 ("Ano") values ('2015');
   insert into weka.assiciacao_a_cooperativas_de_trabalho_producao_2012_2017 ("Ano") values ('2016');
   insert into weka.assiciacao_a_cooperativas_de_trabalho_producao_2012_2017 ("Ano") values ('2017');

  update weka.assiciacao_a_cooperativas_de_trabalho_producao_2012_2017
    set "Não associadas (mil pessoas)" = "Acre"
    from pronto_para_regressao.mercado_nao_estavam_associadas_mil_pessoas
    where assiciacao_a_cooperativas_de_trabalho_producao_2012_2017."Ano" = mercado_nao_estavam_associadas_mil_pessoas."Ano";

    select * from weka.assiciacao_a_cooperativas_de_trabalho_producao_2012_2017;
...
drop table weka.dados_economicos_agregados_2012_2017;
  ...
  update weka.dados_economicos_agregados_2012_2017
    ...
    select * from weka.dados_economicos_agregados_2012_2017;

    drop table weka.previdencia_2010_2017;
    create table weka.previdencia_2010_2017 (
     "Ano" numeric,
     "Arrecadação" numeric,
     "Valor" numeric,
     "Quantidade" numeric);

    insert into weka.previdencia_2010_2017 ("Ano") values ('2010');
    insert into weka.previdencia_2010_2017 ("Ano") values ('2011');
    insert into weka.previdencia_2010_2017 ("Ano") values ('2012');
    insert into weka.previdencia_2010_2017 ("Ano") values ('2014');
    insert into weka.previdencia_2010_2017 ("Ano") values ('2015');
    insert into weka.previdencia_2010_2017 ("Ano") values ('2016');
    insert into weka.previdencia_2010_2017 ("Ano") values ('2017');

    update weka.previdencia_2010_2017
      set "Arrecadação" = "Acre"
      from pronto_para_regressao.quantidade_beneficios_2000_a_2017
      where previdencia_2010_2017."Ano" = quantidade_beneficios_2000_a_2017."Ano";
    update weka.previdencia_2010_2017
      set "Valor" = "Acre"
      from pronto_para_regressao.valor_beneficios_2000_a_2017
      where previdencia_2010_2017."Ano" = valor_beneficios_2000_a_2017."Ano";
    update weka.previdencia_2010_2017
      set "Quantidade" = "Acre"
      from pronto_para_regressao.arrecadacao_2000_a_2017
      where previdencia_2010_2017."Ano" = arrecadacao_2000_a_2017."Ano";

      select * from weka.previdencia_2010_2017;

    drop table weka.desigualdade_2000_2014;
     create table weka.desigualdade_2000_2014 (
     "Ano" numeric,
     "Coeficiente de Gini" numeric,
     "Grau de informalidade definições: I II e III" numeric,
     "Indivíduos pobres com base nas necessidades calóricas" numeric,
    ...
    update weka.desigualdade_2000_2014
      set "Grau de informalidade definições: I II e III" = "Acre"
    ...
    update weka.desigualdade_2000_2014
      set "Indivíduos pobres com base nas necessidades calóricas" = "Acre"
    ...
    update weka.desigualdade_2000_2014
      ...
      select * from weka.desigualdade_2000_2014;
